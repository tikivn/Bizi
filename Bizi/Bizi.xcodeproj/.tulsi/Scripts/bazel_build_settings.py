...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_lap00718/703c5ff1da203c66c35c34b4b3729eb5/execroot/__main__',
    'ios_x86_64',
    {
        'ios_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/lap00718/Library/Application Support/Tulsi/0.20210106.88/Bazel',
